    ...
    <div id="wrapper">
      <section>
        <ul id="gallery">
          ...
          <li>
            <a href="https://brentforwood.com/DrivingApp/index.php" target="_blank">
              <img src="img/driving-app.png" alt="">
              <p>Driving App</p>
            </a>
          </li>
          <li>
            <a href="https://brentforwood.com/FoodApp/index.php" target="_blank">
              <img src="img/food-app.png" alt="">
              <p>Food App</p>
            </a>
          </li>
          <li>
            <a href="https://brentforwood.com/ToDoApp/index.php" target="_blank">
              <img src="img/todo-app.png" alt="">
              <p>To Do App</p>
            </a>
          </li>
          <li>
            <a href="https://forwoodb.github.io/one-page-theme/" target="_blank">
          ...
          <li>
            <a href="https://forwoodb.github.io/htmaw/" target="_blank">
